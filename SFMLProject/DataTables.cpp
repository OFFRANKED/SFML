...
std::vector<AircraftData> initializeAircraftData()
{
	...
	data[Aircraft::Eagle].textureRect = sf::IntRect(40, 0, 40, 40);
...
std::vector<ProjectileData> initializeProjectileData()
{
	...
	data[Projectile::AlliedBullet].texture = Textures::Fire;
	data[Projectile::AlliedBullet].textureRect = sf::IntRect(0, 0, 32, 64);
