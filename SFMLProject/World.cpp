...
{
	mTextures.load(Textures::Entities, "Media/Textures/spaceship.png");
	mTextures.load(Textures::Asteroid, "Media/Textures/rock.png");
	mTextures.load(Textures::Fire, "Media/Textures/fire_red.png");
	mTextures.load(Textures::Jungle, "Media/Textures/background.jpg");
...
void World::addEnemies(sf::Time dt)
{
	time += dt;
	if (time >= sf::seconds(1.f))
	{
		int numx= (rand() % 1024) - 450;
		int numy = (rand() % 768) - 350;
		// Add enemies to the spawn point container
		addEnemy(Aircraft::Raptor, numx, numy);
		time -= sf::seconds(1.f);
	}
